...
$sql3 = "select candidate.first_name,candidate.last_name from candidate where candidate.seat_id=(SELECT user.Seat2 from user where cnic='$cnic_check') and candidate.Party_id='$party_id';";
