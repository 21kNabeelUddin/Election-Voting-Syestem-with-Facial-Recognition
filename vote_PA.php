...
$sql = "select party.party_id ,party.name,candidate.first_name,candidate.last_name from party INNER join candidate on party.party_id=candidate.party_id where candidate.seat_id=(select user.Seat1 from user where user.CNIC='$cnic_check');";
